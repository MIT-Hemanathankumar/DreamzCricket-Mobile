                ...
                <ImageBackground  style={{ backgroundColor: colors.white, width: fullWidth, height: verticalScale(720), alignSelf: 'center'}}>
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        <View style={{ alignSelf: 'center', justifyContent: 'center', alignItems: 'center', marginTop: verticalScale(100) }}>
                            ...
                            {/* <Text style={{ color: colors.white, fontFamily: constants.OPENSANS_FONT_EXTRA_BOLD, fontSize: scaleFont(40) }}>Dreamatch</Text>
                        ...
                        <View style={{ marginTop: verticalScale(300)}}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                <Text style={{ alignSelf: 'center', color: colors.black, fontSize: scaleFont(12), marginTop: verticalScale(14), fontFamily: constants.OPENSANS_FONT_MEDIUM }}>New User? </Text>
